  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path="/forum"
          element={isAuth ? <ForumPage /> : <AuthPage setIsAuth={setIsAuth} />}
        />
        <Route
          path="/mood-tracker"
          element={
            isAuth ? <MoodTrackerPage /> : <AuthPage setIsAuth={setIsAuth} />
          }
        />
        <Route
          path="/admin"
          element={isAuth ? <AdminPage /> : <AuthPage setIsAuth={setIsAuth} />}
        />
      </Routes>
...
function LogoutButton({ signUserOut }) {
  ...
  const showLogoutButton = ["/", "/forum", "/mood-tracker", "/admin"].includes(
    location.pathname
  );
